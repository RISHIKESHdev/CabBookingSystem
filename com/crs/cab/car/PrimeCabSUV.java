...
public class PrimeCabSUV implements Car, PrimeCab {
    ...
    public PrimeCabSUV(String manufacturerName, String model, LocalDateTime manufactureDateTime, int totalPassengerSeatingCapacity, double mileage, String licensePlateNumber) {
