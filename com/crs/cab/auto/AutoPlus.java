...
public class AutoPlus implements Auto, PrimeCab {
    ...
    public AutoPlus(String manufacturerName, String model, String licensePlateNumber, double mileage, int totalPassengerSeatingCapacity, LocalDateTime manufactureDateTime) {
