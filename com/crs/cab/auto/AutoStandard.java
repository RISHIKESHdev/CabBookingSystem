...
public class AutoStandard implements Auto, StandardCab {
    ...
    public AutoStandard(String manufacturerName, String model, String licensePlateNumber, double mileage, int totalPassengerSeatingCapacity, LocalDateTime manufactureDateTime) {
